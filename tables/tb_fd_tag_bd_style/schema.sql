...
CREATE TABLE tb_fd_tag_bd_style (
    ...
    c_is_locked VARCHAR(10) COMMENT '是否定开(1是/0否)',
    -- 券种风格（近八期季报）
    ...
    c_fin_bd_chg_avg DECIMAL(10,4) COMMENT '金融债仓位变动均值(%)',
    c_bd_type_style VARCHAR(30) COMMENT '券种风格标签',
    c_bd_type_timing VARCHAR(20) COMMENT '券种择时标签',
    -- 杠杆风格（近八期季报）
    c_leverage_avg DECIMAL(10,4) COMMENT '杠杆率均值',
    c_leverage_chg_avg DECIMAL(10,4) COMMENT '杠杆率绝对变动均值',
    c_leverage_pref VARCHAR(20) COMMENT '杠杆偏好标签',
    c_leverage_timing VARCHAR(20) COMMENT '杠杆择时标签',
    -- 信用风格（近四期半年报）
    ...
    c_credit_pref VARCHAR(20) COMMENT '信用偏好标签',
    c_credit_timing VARCHAR(20) COMMENT '信用择时标签',
    -- 久期风格（近四期半年报）
    c_duration_avg DECIMAL(10,4) COMMENT '久期均值(年)',
    c_duration_chg_avg DECIMAL(10,4) COMMENT '久期变动均值(年)',
    c_duration_pref VARCHAR(20) COMMENT '久期偏好标签',
    c_duration_timing VARCHAR(20) COMMENT '久期择时标签',
