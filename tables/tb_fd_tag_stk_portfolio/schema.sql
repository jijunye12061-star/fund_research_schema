...
(
    ...
    c_crowd_score               DECIMAL(10,4)  COMMENT '全市场抱团度（预留，待实现）',
    c_crowd_internal_score      DECIMAL(10,4)  COMMENT '同公司抱团度（预留，待实现）',

    -- 交易特征
    c_turnover_avg              DECIMAL(10,4)  COMMENT '基金换手率均值（倍，预留，待实现）',
    c_turnover_tag              VARCHAR(10)    COMMENT '换手率标签：高换手/中换手/低换手（预留，待实现）',
